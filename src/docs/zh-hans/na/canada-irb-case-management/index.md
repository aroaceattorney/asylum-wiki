...
> [!TIP]
> 有些问题可能对于声请人而言是敏感的（例如：描述家庭暴力的具体细节），声请人可以把这些问题视作为一个解释的机会，而非由审裁官的问题断定出”ta不会信我的“这一点。

5：在这之后，声请人的代表（如有）会对声请人发问，声请人的代表问的问题通常来讲对声请人是有利的。

6：如果IRB还叫非声请人的证人过来的话，那么证人此时将会被允许进入会议室，随后步骤3，4，5对那个证人又来一边
...
IRB的统计数据现实2023年4月提出的新声请的平均等待时间为

::: info 2023年4月提出的新声请的平均等待时间：
...
> [!IMPORTANT]
> 
> IRB决定一个声请可以通过简易程序审理的决定**并不代表** 这个声请一定会被接纳，或是声请人一定会被认可成为难民。只要这个声请本身的决定还没有做出，或是审裁官想这么干（通常是因为有法律/事实问题需要一个听证会解决的）IRB随时可以把那个循简易程序审理的声请发配回正常排听证会的流程。
