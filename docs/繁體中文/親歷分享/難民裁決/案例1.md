...
[10] When claimants swear to the truth, this creates a presumption that their allegations are true, unless there are reasons to doubt their credibility[^3]. Having considered the documents provided by the claimant in this case, the Panel finds that she has established her allegations on a balance of probabilities. On this basis, the Panel concludes that the claimant fears persecution that she has set forth in her written narrative[^4].

[11] Among the submitted evidence, the claimant has provided a letter from her wife,[REDACTED] describing the reaction of the claimant's parents to her gender identity and the implications of Chinese policy towards transgender persons[^5]. Furthermore, she has submitted a letter from Dr. [REDACTED] confirming her diagnosis of gender incongruence and her medication for hormone replacement therapy[^6]. The claimant has also provided copies of WeChat messages between her and her mother which reveal the familial tensions which the claimant's change of gender identity has raised[^7]. In addition, the claimant has submitted a letter from a mental health
counselor,[REDACTED], which attests to the negative psychological impact that the claimant's conflict with her family has had on her[^8].

### Nature of the Harm

[12] Based on the claimant's allegations, the Panel has examined her claim for refugee protection under section 96 of the IRPA. It concludes that the claimant has a well-founded fear of persecution based on at least one of the grounds prescribed under the Refugee Convention. Specifically, the claimant faces discrimination amounting to persecution due to her membership in a particular social group.

[13] In Canada, the Supreme Court has recognized that sexual orientation can be considered as a particular social group[^9]. According to Guideline 9, this categorization extends to gender identity and expression, as well as to sex characteristics.

### Well-Founded Fear

[14] Upon considering the available evidence, the Panel finds that the claimant has also established a prospective risk of being subjected to persecution. This risk is corroborated by evidence found in the National Documentation Package on China pertaining to the conditions faced by sexual minorities in that country.

[15] Despite the weight of tradition, acceptance of LGBT people in China has clearly progressed in recent years. The transformation from man to woman is anchored in many areas of Chinese culture, such as entertainment. Social acceptance, however, assumes that the transgender person actually changes sex and then has heterosexual relations. In a context where conventional views of marriage remain strong, many people are forced to keep their homosexuality hidden[^10].

[16] According to the Chinese Classification of Diagnostic Criteria for Mental Disabilities, the status of transgender people now falls under the category of gender dysphoria. In this context, candidates for sex reassignment must undergo examination by a mental health professional[^11]. Furthermore, psychological and psychiatric interventions against gender dysphoria must have been proven ineffective for at least one year[^12].
...
[20] In effect, the documentary evidence confirms the claimant's fears about the conditions that she would face upon return to China. On these grounds, the Panel finds that the claimant would face discrimination amounting to persecution if such a return were to take place.
...
[23] The courts are rarely called upon because, on the one hand, potential plaintiffs are reluctant to present an aggressive posture towards the police. On the other hand, plaintiffs are not in favour
of making public any conflict with representatives of the State or with any natural or legal person[^20].

[24] In light of the documentary evidence, the Panel finds that the claimant would not have adequate recourse against the discriminatory policies of the Chinese government. Given her particular circumstances, including those related to her gender identity, the Panel finds that the presumption of state protection has been refuted where she is concerned.

### Internal Flight Alternative

[25] Based on the evidence contained in her file, the Panel finds that the claimant faces a serious possibility of persecution throughout China. Therefore, the Panel concludes that a viable Internal Flight Alternative is currently not available for the claimant within her country of nationality[^21].
...
[^2]: Document 2 - Package forwarded by the Minister - The claimant's passport.

[^3]: [*Maldonado* \[1980\] 2.F.C. 302 (C.A.)](https://canlii.ca/t/jqkrb)

[^4]: Document 1 - Basis of Claim form.

[^5]: Document 4 - Exhibit D-5.

[^6]: Document 4 - Exhibit D-6.

[^7]: Document 4 - Exhibit D-8.

[^8]: Document 4 - Exhibit D-9.
...
[^12]: Document 3 - Tab 6.5 : ["I need my parents' consent to be myself": Barriers to gender-affirming treatments for transgender people in China](https://www.amnesty.org/en/wp-content/uploads/2021/05/ASA1702692019ENGLISH.pdf), Amnesty International, 9 May 2019.

[^13]: Document 3 - Tab 6.2 - *Supra*, note 10.

[^14]: Document 3 - Tab 6.5 - *Supra*, note 12.

[^15]: Document 3 - Tab 6.2 - *Supra*, note 10.

[^16]: Document 3 - Tab 6.5 - *Supra*, note 12.

[^17]: Document 3 - Tab 6.2 - *Supra*, note 10.

[^18]: Ward [1993] S.C.R. 689.

[^19]: Document 3 - Tab 6.2 - *Supra*, note 10.

[^20]: Document 3 - Tab 6.2 - *Ibid*.

[^21]: [*Thirunavukkarasu* \[1994\] 1 F.C. 589 (C.A.)](https://canlii.ca/t/4nld)

[^22]: Document 3 - Tab 6.2 - *Supra*, note 10.

[^23]: Document 3 - Tab 6.2 - *Ibid*.

[^24]: Document 3 - Tab 6.2 - *Ibid*.
